# Release Notes — gaia-lstm2 v1.0.0
...
> Structure of the Error Distribution in Autoregressive Stochastic Models**
...
@article{hubka2026threemodes,
  ...
  title   = {Three Measurable Failure Modes of Large Language Models:
             Structure of the Error Distribution in Autoregressive
             Stochastic Models},
  year    = {2026},
  doi     = {PLACEHOLDER}
}
